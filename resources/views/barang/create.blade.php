                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="text-muted">Masukkan kode unik untuk identifikasi barang</small>
                            </div>
                        </div>
                    ...
                    <div class="alert alert-info mb-4">
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Data barang akan digunakan sebagai referensi untuk pencatatan barang masuk dan keluar. Pastikan kode barang bersifat unik.</p>
                            </div>
                        </div>
                    </div>
